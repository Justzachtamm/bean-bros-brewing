...
September 6, 2026: Created hello@beanbrosbrewingco.com as a Google Workspace alternate email for zach@beanbrosbrewingco.com. Brevo lists the new hello sender as Verified, with DKIM and DMARC configured. Changed website sender and reply-to to hello and deployed production deploy 6a9e1a211af6e180524f5917. Inbox delivery has not yet been tested. Google Admin visibly displayed the existing Bean Bros full logo as the business account profile photo; attempted monogram replacement failed with browser file upload Not allowed and was not completed. Recipient Gmail avatar appearance is not verified.
